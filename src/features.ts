...
export const REELORA_FEATURES = [
  ...
  "uploaded-ai-video-reedit",
  "uploaded-ai-video-recreate",
  "all-uploaded-videos-required",
  "balanced-multi-source-remix",
  "per-upload-source-usage-report",
  "scene-isolated-remix-windows",
...
export function defaultAdvancedOptions(highlight: HighlightIntent, overrides: ReeloraAdvancedOptions = {}): ReeloraAdvancedOptions {
  ...
  return {
    ...
    sourceKind: overrides.sourceKind ?? "raw_footage",
    remixMode: overrides.remixMode ?? "re_edit",
    preserveSourceSequence: overrides.preserveSourceSequence ?? overrides.remixMode !== "recreate",
    useAllUploadedVideos: overrides.useAllUploadedVideos ?? true,
    inputSourceCount: overrides.inputSourceCount,
    autoVerticalReframe: overrides.autoVerticalReframe ?? true,
    landscapeReframeMode: overrides.landscapeReframeMode ?? "auto",
