...
app.get("/health", (_req, res) => {
  res.json({ ok: true, service: "reelora", version: "0.7.1", preservationMode: "strict-no-generative", aiVideoRemix: true, multiSourceCoverage: true, automaticVerticalReframe: true });
});
...
app.listen(port, "0.0.0.0", () => {
  console.log(`Reelora v0.7.1 MCP server listening on port ${port}`);
});
