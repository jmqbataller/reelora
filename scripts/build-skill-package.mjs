...
const agents = path.join(skillRoot, "agents");
  ...
  JSON.stringify(
    {
      ...
      aiVideoRemixDefaults: {
        ...
        requireMaterialReedit: true,
        maxVisualSimilarity: 0.94,
        maxSourceTimelineRetention: 0.90,
        audibleAudioPeakFloorDb: -55,
        noWatermarkFromLogo: true,
      ...
      prohibitions: ["overlay-text", "overlay-objects", "logo-watermark", "ai-voice-over", "generative-video-replacement"],
    },
    null,
    2,
  ),
